public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: dequeue function removed from index 1 instead of 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Queue function was inserting each new value at 0 index
        ...
        // Defect(s) Found: No error was found
    }
